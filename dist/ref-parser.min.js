...
"use strict";function $RefParserOptions(e){this.allow={json:!0,yaml:!0,empty:!0,unknown:!0},this.$refs={internal:!0,external:!0,circular:!0},this.cache={fs:60,http:300,https:300},this.http={headers:{},timeout:5e3,redirects:5,withCredentials:!1},merge(e,this)}function merge(e,t){if(e)for(var r=Object.keys(e),s=0;s<r.length;s++){var i=r[s],n=e[i];if(void 0===t[i])t[i]=n;else for(var a=Object.keys(n),o=0;o<a.length;o++){var h=a[o],l=n[h];void 0!==l&&(t[i][h]=l)}}}module.exports=$RefParserOptions;
...
(function (process){
"use strict";var isWindows=/^win/.test(process.platform),forwardSlashPattern=/\//g,protocolPattern=/^([a-z0-9.+-]+):\/\//i,urlEncodePatterns=[/\?/g,"%3F",/\#/g,"%23",isWindows?/\\/g:/\//,"/"],urlDecodePatterns=[/\%23/g,"#",/\%24/g,"$",/\%26/g,"&",/\%2C/g,",",/\%40/g,"@"];exports.cwd=function(){return process.browser?location.href:process.cwd()+"/"},exports.isUrl=function(r){var e=protocolPattern.exec(r);return e?(e=e[1].toLowerCase(),"file"!==e):!1},exports.localPathToUrl=function(r){if(!process.browser&&!exports.isUrl(r)){for(var e=0;e<urlEncodePatterns.length;e+=2)r=r.replace(urlEncodePatterns[e],urlEncodePatterns[e+1]);r=encodeURI(r)}return r},exports.urlToLocalPath=function(r,e){r=decodeURI(r);for(var t=0;t<urlDecodePatterns.length;t+=2)r=r.replace(urlDecodePatterns[t],urlDecodePatterns[t+1]);var s="file://"===r.substr(0,7).toLowerCase();if(s){var o="file:///",n="/"===r[7]?r.substr(8):r.substr(7);isWindows&&"/"===n[1]&&(n=n[0]+":"+n.substr(1)),e?r=o+n:(s=!1,r=isWindows?n:"/"+n)}return isWindows&&!s&&(r=r.replace(forwardSlashPattern,"\\")),r},exports.getHash=function(r){var e=r.indexOf("#");return e>=0?r.substr(e):"#"},exports.stripHash=function(r){var e=r.indexOf("#");return e>=0&&(r=r.substr(0,e)),r},exports.extname=function(r){var e=r.lastIndexOf(".");return e>=0?r.substr(e).toLowerCase():""};

}).call(this,require('_process'))

},{"_process":66}],8:[function(require,module,exports){
"use strict";function Pointer(e,r){this.$ref=e,this.path=r,this.value=void 0,this.circular=!1}function resolveIf$Ref(e,r){if($Ref.isAllowed$Ref(e.value,r)){var t=url.resolve(e.path,e.value.$ref);if(t!==e.path){var i=e.$ref.$refs._resolve(t);return 1===Object.keys(e.value).length?(e.$ref=i.$ref,e.path=i.path,e.value=i.value):e.value=util.dereference(e.value,i.value),!0}e.circular=!0}}function setValue(e,r,t){if(!e.value||"object"!=typeof e.value)throw ono.syntax('Error assigning $ref pointer "%s". \nCannot set "%s" of a non-object.',e.path,r);return"-"===r&&Array.isArray(e.value)?e.value.push(t):e.value[r]=t,t}module.exports=Pointer;var $Ref=require("./ref"),util=require("./util"),url=require("url"),ono=require("ono"),slashes=/\//g,tildes=/~/g,escapedSlash=/~1/g,escapedTilde=/~0/g;Pointer.prototype.resolve=function(e,r){var t=Pointer.parse(this.path);this.value=e;for(var i=0;i<t.length;i++){resolveIf$Ref(this,r)&&(this.path=Pointer.join(this.path,t.slice(i)));var s=t[i];if(void 0===this.value[s])throw ono.syntax('Error resolving $ref pointer "%s". \nToken "%s" does not exist.',this.path,s);this.value=this.value[s]}return resolveIf$Ref(this,r),this},Pointer.prototype.set=function(e,r,t){var i,s=Pointer.parse(this.path);if(0===s.length)return this.value=r,r;this.value=e;for(var a=0;a<s.length-1;a++)resolveIf$Ref(this,t),i=s[a],this.value&&void 0!==this.value[i]?this.value=this.value[i]:this.value=setValue(this,i,{});return resolveIf$Ref(this,t),i=s[s.length-1],setValue(this,i,r),e},Pointer.parse=function(e){var r=util.path.getHash(e).substr(1);if(!r)return[];r=r.split("/");for(var t=0;t<r.length;t++)r[t]=decodeURI(r[t].replace(escapedSlash,"/").replace(escapedTilde,"~"));if(""!==r[0])throw ono.syntax('Invalid $ref pointer "%s". Pointers must begin with "#/"',r);return r.slice(1)},Pointer.join=function(e,r){-1===e.indexOf("#")&&(e+="#"),r=Array.isArray(r)?r:[r];for(var t=0;t<r.length;t++){var i=r[t];e+="/"+encodeURI(i.replace(tildes,"~0").replace(slashes,"~1"))}return e};
...
},{"./_stream_duplex":72,"_process":66,"buffer":57,"core-util-is":77,"events":61,"inherits":63,"isarray":65,"process-nextick-args":78,"stream":84,"string_decoder/":90,"util":56}],75:[function(require,module,exports){
...
},{"./_stream_duplex":72,"buffer":57,"core-util-is":77,"events":61,"inherits":63,"process-nextick-args":78,"stream":84,"util-deprecate":79}],77:[function(require,module,exports){
(function (Buffer){
